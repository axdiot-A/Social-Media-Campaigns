...
<body>
	...
	<?php
		...
		if(isset($_POST['search'])){
			...
			$sql = "SELECT * FROM user WHERE role='user' AND
            (fname LIKE '%$keyword%' OR lname LIKE '%$keyword%' OR 
            email LIKE '%$keyword%' OR country LIKE '%$keyword%')";
